...
class Page
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Lien", mappedBy="page")
     */
    private $liens;
    ...
    public function getNomChemin(): ?string
    {
        return $this->nomChemin;
    }

    public function setNomChemin(string $nomChemin): self
    {
