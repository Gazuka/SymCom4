 ...
 */
final class Version20200508135759 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mediatheque_drive_commande_etat (id INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, etat VARCHAR(255) NOT NULL, date DATETIME NOT NULL, message VARCHAR(255) DEFAULT NULL, INDEX IDX_80C9244C82EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE mediatheque_drive_commande_etat ADD CONSTRAINT FK_80C9244C82EA2E54 FOREIGN KEY (commande_id) REFERENCES mediatheque_drive_commande (id)');
        ...
        $this->addSql('ALTER TABLE mediatheque_drive_commande ADD archive TINYINT(1) NOT NULL, DROP etat, CHANGE creneau_id creneau_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mediatheque_drive_creneau CHANGE etat etat VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE mediatheque_membre CHANGE famille_id famille_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE mediatheque_drive_commande_etat');
        ...
        $this->addSql('ALTER TABLE mediatheque_drive_commande ADD etat VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP archive, CHANGE creneau_id creneau_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mediatheque_drive_creneau CHANGE etat etat VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE mediatheque_membre CHANGE famille_id famille_id INT DEFAULT NULL');
