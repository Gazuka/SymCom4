 ...
 */
final class Version20200404123545 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE structure ADD illustration_id INT DEFAULT NULL, CHANGE site_id site_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE structure DROP illustration_id, CHANGE site_id site_id INT DEFAULT NULL');
    }
}
