 ...
 */
final class Version20200508140009 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mediatheque_drive_commande_etat ADD bloquant TINYINT(1) NOT NULL, CHANGE message message VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mediatheque_drive_commande CHANGE creneau_id creneau_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mediatheque_drive_commande_etat DROP bloquant, CHANGE message message VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
