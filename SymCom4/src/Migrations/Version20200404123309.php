 ...
 */
final class Version20200404123309 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE illustration (id INT AUTO_INCREMENT NOT NULL, image_id INT NOT NULL, UNIQUE INDEX UNIQ_D67B9A423DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, media_id INT NOT NULL, descriptif VARCHAR(255) NOT NULL, INDEX IDX_C53D045FEA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE structure CHANGE site_id site_id INT DEFAULT NULL');
    }
