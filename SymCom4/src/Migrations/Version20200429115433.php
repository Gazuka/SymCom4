 ...
 */
final class Version20200429115433 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE creneau_drive_mediatheque (id INT AUTO_INCREMENT NOT NULL, debut DATETIME NOT NULL, fin DATETIME NOT NULL, ouvert TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commande_drive_mediatheque ADD creneau_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_51E763D27D0729A9 ON commande_drive_mediatheque (creneau_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_51E763D27D0729A9 ON commande_drive_mediatheque');
        $this->addSql('ALTER TABLE commande_drive_mediatheque DROP creneau_id');
        $this->addSql('ALTER TABLE dossier CHANGE parent_id parent_id INT DEFAULT NULL');
