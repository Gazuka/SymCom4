 ...
 */
final class Version20200406165129 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact DROP titre');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD titre VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE dossier CHANGE parent_id parent_id INT DEFAULT NULL');
