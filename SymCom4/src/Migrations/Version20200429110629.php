 ...
 */
final class Version20200429110629 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE membre_mediatheque_membre_mediatheque (membre_mediatheque_source INT NOT NULL, membre_mediatheque_target INT NOT NULL, INDEX IDX_E26FC9E5AB86E45D (membre_mediatheque_source), INDEX IDX_E26FC9E5B263B4D2 (membre_mediatheque_target), PRIMARY KEY(membre_mediatheque_source, membre_mediatheque_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
