 ...
 */
final class Version20200406084913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP INDEX IDX_C53D045FEA9FDD75, ADD UNIQUE INDEX UNIQ_C53D045FEA9FDD75 (media_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP INDEX UNIQ_C53D045FEA9FDD75, ADD INDEX IDX_C53D045FEA9FDD75 (media_id)');
