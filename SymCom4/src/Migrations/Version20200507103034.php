 ...
 */
final class Version20200507103034 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mediatheque_drive_creneau ADD etat VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mediatheque_drive_commande CHANGE creneau_id creneau_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mediatheque_drive_creneau DROP etat');
        $this->addSql('ALTER TABLE mediatheque_membre CHANGE famille_id famille_id INT DEFAULT NULL');
