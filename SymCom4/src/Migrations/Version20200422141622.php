 ...
 */
final class Version20200422141622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD email VARCHAR(255) NOT NULL, ADD slug VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_association CHANGE parent_id parent_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE type_entreprise CHANGE parent_id parent_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE utilisateur DROP email, DROP slug');
    }
}
