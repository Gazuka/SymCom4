 ...
 */
final class Version20200504150514 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande_drive_mediatheque ADD etat VARCHAR(255) NOT NULL, CHANGE creneau_id creneau_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande_drive_mediatheque DROP etat, CHANGE creneau_id creneau_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE dossier CHANGE parent_id parent_id INT DEFAULT NULL');
