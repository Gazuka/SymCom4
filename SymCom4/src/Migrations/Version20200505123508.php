 ...
 */
final class Version20200505123508 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mediatheque_membre_mediatheque_membre (mediatheque_membre_source INT NOT NULL, mediatheque_membre_target INT NOT NULL, INDEX IDX_FC41359C2C84C83 (mediatheque_membre_target), INDEX IDX_FC41359DB2D1C0C (mediatheque_membre_source), PRIMARY KEY(mediatheque_membre_source, mediatheque_membre_target)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
