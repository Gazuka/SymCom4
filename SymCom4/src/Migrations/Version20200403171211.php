 ...
 */
final class Version20200403171211 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lien (id INT AUTO_INCREMENT NOT NULL, page_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, font_awesome VARCHAR(255) DEFAULT NULL, extern TINYINT(1) NOT NULL, url VARCHAR(255) DEFAULT NULL, color_boot VARCHAR(255) DEFAULT NULL, INDEX IDX_A532B4B5C4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE lien ADD CONSTRAINT FK_A532B4B5C4663E4 FOREIGN KEY (page_id) REFERENCES page (id)');
