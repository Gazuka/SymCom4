 ...
 */
final class Version20200406143545 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE humain DROP date_naissance, CHANGE prenom prenom VARCHAR(255) DEFAULT NULL, CHANGE sexe sexe TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE horaire CHANGE lieu_id lieu_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE humain ADD date_naissance DATE DEFAULT \'NULL\', CHANGE prenom prenom VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE sexe sexe TINYINT(1) DEFAULT \'NULL\'');
