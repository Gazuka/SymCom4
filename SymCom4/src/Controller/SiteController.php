...
class SiteController extends SymCom4Controller
{
    ...
    {
        $this->outilsBox->defineTwig('site/index.html.twig');
    ...
    public function structure($slugstructure):Response
    {
        ...
        {
            case 'association':
                $this->outilsBox->defineTwig('site/pages/association.html.twig'); 
            break;
            case 'service':
    ...
    public function associations():Response
    {
        ...
        $this->outilsBox->defineTwig('site/pages/associations.html.twig');
